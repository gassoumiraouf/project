...
class ProductDetails extends Component {
    ...
    componentDidMount() {
        this.setState(
            ...this.props.products.products.filter(prod => String(prod.id) === this.props.match.params.id)
        );
    }
